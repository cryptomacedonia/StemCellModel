...
class Cell(Agent):
    ...
    def step(self):
        self.model.move_agent_randomly_with_probability(self)
        if tools.current_milli_time() - self.last_time_I_received_parent_signal_and_attached_my_signature > 4000 and str(self.parent_id) != "ABC":
...
tools.start_simulation(40,40,[Cell(color="#f54242"),Cell(color="#15bce6"), Cell(color="#BF07F2"),  Cell(color="#1DA526")])
# tools.start_simulation(30,30,[Cell(color="#f54242")])
